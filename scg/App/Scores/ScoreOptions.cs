...
namespace scg.App.Scores
{
    ...
    {
        [Value(0, MetaName = "Operation", HelpText = "Supported operations: add, remove", Required = true)]
        public string Operation { get; set; }

        [Value(1, MetaName = "GameName", HelpText = "The identifier of the game. E.g. GlassRoad", Required = true)]
