...
public static class Filename
{
    ...
    public static readonly string GeeklistPostGenerators = "GeeklistPost.gen";
    public static readonly string Metadata = "Metadata.json";
    public static readonly string PreviousChallenges = "PreviousChallenges.dat";
    public static readonly string GeeklistId = "GeeklistId.dat";
}